...
class Test extends Component {
    ...
    Insert() {
        ...
        axios.post('http://localhost:82/insert.php', data)
    ...
    Update() {
        ...
        const axios = require('axios');
        axios.post('http://localhost:82/update.php', data)
            .then(function (response) {
                console.log(response);
                window.location.reload();
            })
    ...
    Delete() {
        ...
        const axios = require('axios');
        axios.post('http://localhost:82/delete.php', data)
            .then(function (response) {
                console.log(response);
                window.location.reload();
            })
    ...
    componentDidMount(Code) {
        const axios = require("axios");
        axios
            .get("http://localhost:82/select.php")
            .then((response) => {
