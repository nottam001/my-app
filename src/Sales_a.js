...
class Sales_a extends Component {
    constructor(props) {
        super(props);
        this.state = {
            arr: [
                { name: "กะเพราไก่", item: 15200 },
                { name: "แกงจืด", item: 14500 },
                { name: "ผัดไทย", item: 13800 },
                { name: "ข้าวหมูกรอบไข่ต้ม", item: 13600 },
                { name: "ข้าวต้มกุ้ง", item: 13000 },
                { name: "ข้าวผัดปู", item: 12600 },
            ]
        };
    }
    render() {
                            ...
                            <div class="col-6 mt-3 border-end border-2 border-secondary" style={divStyle}>
                                ...
                                <div class="row mt-2">
                                    <div class="col">
                                        ...
                                        <button class="btn btn-success ms-1 me-5">
                                            คลอดการเปิดราย
                                        </button>
