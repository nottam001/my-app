...
class Sales_y extends Component {
    constructor(props) {
        ...
        this.state = {
            arr: [
                { name: "กะเพราไก่", item: 1520 },
                { name: "แกงจืด", item: 1450 },
                { name: "ผัดไทย", item: 1380 },
                { name: "ข้าวหมูกรอบไข่ต้ม", item: 1360 },
                { name: "ข้าวต้มกุ้ง", item: 1300 },
                { name: "ข้าวผัดปู", item: 1260 },
            ]
        };
    }
    render() {
                            ...
                            <div class="col-6 mt-3 border-end border-2 border-secondary" style={divStyle}>
                                ...
                                <div class="row mt-2">
                                    <div class="col">
                                        ...
                                        <button class="btn btn-success ms-1" onClick={() => { this.props.history.replace('/ss') }}>
                                            ต่อปี
                                        </button>
